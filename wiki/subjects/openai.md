...
OpenAI and Pine Labs announced a partnership to embed AI APIs directly into Pine Labs' payments and commerce infrastructure, automating settlement, reconciliation, and invoicing workflows[^openai-pinelabs-2026-02-18]. Pine Labs CEO B Amrish Rau said the company already uses AI internally to cut daily settlement clearing from hours to minutes, and the deal will extend those gains to merchants and corporate clients — with B2B use cases leading consumer-facing applications[^openai-pinelabs-2026-02-18].

The deal marks OpenAI's deepening push into India's regulated fintech layer, mirroring its Stripe partnership in the US[^openai-pinelabs-2026-02-18]. For Scapia, the signal is structural: AI is entering the settlement and merchant rails that underpin card commerce. Fully agentic payments face RBI constraints for now, but Pine Labs' Setu unit is already prototyping agent-led bill payments, and international markets are further ahead — India is likely to follow[^openai-pinelabs-2026-02-18].
